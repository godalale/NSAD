...
void generateEvents(const std::string& configFile, const std::string& outputFile, int numEvents = 100000) {
...
int main(int argc, char* argv[]) {
    ...
    std::string outputFile = "output.root";  // You can customize the output file name based on the config file
